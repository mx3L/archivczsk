...
if [ -d ${DP}/sh4 ] && [ -d ${DP}/mipsel ]; then
	echo "sh4/mipsel binaries are already downloaded"
else
...
Section: extra
Priority: optional
Depends: python-html python-threading python-json python-encodings python-zlib

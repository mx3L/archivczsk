...
from ..seeker import SubtitlesDownloadError, SubtitlesCaptchaError
...
def download_subtitles (subtitles_list, pos, zip_subs, tmp_sub_dir, sub_folder, session_id): #standard input
    ...
    if password == '' or username == '':
        ...
        if client.login(username,password) == False:
            ...
            raise SubtitlesDownloadError("Login to Titulky.com failed. Check your username/password at the addon configuration")
    ...
    if not None == cannot_download:
        ...
        raise SubtitlesDownloadError("Subtitles cannot be downloaded, user needs to login")
        return True,subtitles_list[pos]['language_name'], ""

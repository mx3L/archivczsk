#ifndef __servicemp4_h
#define __servicemp4_h
...
class eStaticServiceMP4Info;

class eServiceFactoryMP4: public iServiceHandler
{
	DECLARE_REF(eServiceFactoryMP4);
public:
	eServiceFactoryMP4();
...
private:
	ePtr<eStaticServiceMP4Info> m_service_info;
};

class eStaticServiceMP4Info: public iStaticServiceInformation
{
	DECLARE_REF(eStaticServiceMP4Info);
	friend class eServiceFactoryMP4;
...
private:
	...
	static void playbinNotifySource(GObject *object, GParamSpec *unused, gpointer data);
	...
	ePtr<eTimer> m_download_poll_timer;
